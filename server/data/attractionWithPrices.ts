...
export const attractionWithPrices: Attraction[] = [
  // Paris, France
  {
    name: "Eiffel Tower",
  ...
  },
  {
    name: "Louvre Museum",
    description:
      "World-renowned art museum housing the Mona Lisa and vast collections.",
    lat: 48.8606,
    lon: 2.3376,
  ...
  },
  {
    ...
    description:
      "Historic Gothic cathedral known for its architecture and history.",
    lat: 48.853,
    lon: 2.3499,
  ...
  },
  {
    ...
    description:
      "Monumental arch honoring Napoleon's victories and French history.",
    lat: 48.8738,
    lon: 2.295,
  ...
  // Nice, France
  {
    ...
    description:
      "Famous seafront promenade with scenic views of the Mediterranean.",
    lat: 43.6951,
    lon: 7.2651,
  ...
  },
  {
    ...
    description:
      "Charming historic district with narrow streets and vibrant markets.",
    lat: 43.6961,
    lon: 7.2746,
  ...
  },
  {
    name: "Musée Matisse",
    description:
      "Museum showcasing the works of Henri Matisse in a 17th-century villa.",
    lat: 43.7193,
    lon: 7.2761,
  ...
  },
  {
    name: "Nice Cathedral",
    description:
      "Baroque cathedral dedicated to Saint Reparata in the heart of Nice.",
    lat: 43.6973,
    lon: 7.2709,
  ...
  // Lyon, France
  {
    ...
    description:
      "Iconic hilltop basilica with ornate interiors and city views.",
    lat: 45.7621,
    lon: 4.8226,
  ...
  },
  {
    name: "Vieux Lyon",
    description:
      "Historic Renaissance district with traboules and cobblestone streets.",
    lat: 45.7597,
    lon: 4.8278,
  ...
  },
  {
    ...
    description:
      "Art museum in a former abbey with extensive European collections.",
    lat: 45.7667,
    lon: 4.8338,
  ...
  },
  {
    ...
    description:
      "Gothic church with Renaissance art and Titian's masterpieces.",
    lat: 45.4372,
    lon: 12.326,
  ...
  },
  {
    ...
    lon: 100.5281,
    address:
      "6 Soi Kasem San 2, Rama 1 Rd, Pathum Wan, Bangkok 10330, Thailand",
  ...
  },
  {
    ...
    description:
      "Byzantine church dedicated to the patron saint of Thessaloniki.",
    lat: 40.6389,
    lon: 22.9475,
  ...
  },
  {
    name: "Xcaret Park",
    description:
      "Eco-archaeological park with cultural and natural attractions.",
    lat: 20.5809,
    lon: -87.1189,
    address:
      "Carretera Chetúmal-Puerto Juárez Km 282, 77710 Playa del Carmen, Q.R., Mexico",
    wikiTitle: "Xcaret",
    cityName: "Cancun",
  ...
  },
  {
    ...
    lon: -99.1863,
    address:
      "Av. Paseo de la Reforma s/n, Polanco, 11560 Ciudad de México, Mexico",
  ...
  },
  {
    ...
    lon: -99.1629,
    address:
      "Calle Londres 247, Del Carmen, Coyoacán, 04100 Ciudad de México, Mexico",
  ...
  },
  {
    ...
    lon: -103.339,
    address:
      "Calle Cabañas 8, San Juan de Dios, 44360 Guadalajara, Jal., Mexico",
  ...
  },
  {
    ...
    lon: -103.344,
    address:
      "Calle Degollado s/n, Zona Centro, 44100 Guadalajara, Jal., Mexico",
  ...
  },
  {
    ...
    lon: -103.3398,
    address:
      "Calle Javier Mina 52, San Juan de Dios, 44360 Guadalajara, Jal., Mexico",
  ...
  },
  {
    name: "KLCC Park",
    description:
      "Urban park with jogging trails and a lake near the Petronas Towers.",
    lat: 3.1558,
    lon: 101.7153,
    address:
  ...
  // Penang, Malaysia
  {
    name: "George Town",
    description:
      "UNESCO-listed historic district with colonial and street art.",
    lat: 5.4164,
    lon: 100.3407,
  ...
  },
  {
    ...
    description:
      "Largest Buddhist temple in Malaysia with a seven-story pagoda.",
    lat: 5.3992,
    lon: 100.2743,
  ...
  // São Paulo, Brazil
  {
    ...
    description:
      "Iconic museum with a vast collection of Western and Brazilian art.",
    lat: -23.5614,
    lon: -46.6559,
  ...
  },
  {
    ...
    description:
      "Large urban park with museums, planetarium, and green spaces.",
    lat: -23.5874,
    lon: -46.6576,
  ...
  },
  {
    ...
    description:
      "Art museum showcasing Brazilian works in a historic building.",
    lat: -23.5343,
    lon: -46.6339,
  ...
  },
  {
    ...
    description:
      "Vibrant market known for exotic fruits and gourmet food stalls.",
    lat: -23.5419,
    lon: -46.6297,
  ...
  // Cape Town, South Africa
  {
    name: "Table Mountain",
    description:
      "Iconic flat-topped mountain with cableway and panoramic views.",
    lat: -33.9628,
    lon: 18.4038,
  ...
  // Johannesburg, South Africa
  {
    ...
    lon: 28.0093,
    address:
      "Northern Parkway & Gold Reef Rd, Johannesburg, 2001, South Africa",
  ...
  },
  {
    ...
    description:
      "Historic site with a prison and South Africa’s Constitutional Court.",
    lat: -26.1904,
    lon: 28.0423,
  ...
  },
  {
    name: "Soweto",
    description:
      "Historic township with sites like the Hector Pieterson Museum.",
    lat: -26.2485,
    lon: 27.854,
  ...
  // Durban, South Africa
  {
    ...
    description:
      "Aquarium and theme park with marine exhibits and water slides.",
    lat: -29.8673,
    lon: 31.046,
  ...
  },
  {
    ...
    description:
      "Historic parliament building with a glass dome offering city views.",
    lat: 52.5186,
    lon: 13.3762,
  ...
  // Hamburg, Germany
  {
    ...
    description:
      "Modern concert hall on the Elbe River with glass architecture.",
    lat: 53.5413,
    lon: 9.9841,
  ...
  // Amsterdam, Netherlands
  {
    name: "Rijksmuseum",
    description:
      "National museum with Dutch art and history, including Rembrandt’s works.",
    lat: 52.36,
    lon: 4.8852,
  ...
  },
  {
    name: "Vondelpark",
    description:
      "Large urban park with ponds, paths, and open-air performances.",
    lat: 52.3581,
    lon: 4.8686,
  ...
  },
  {
    name: "Markthal",
    description:
      "Modern market hall with food stalls and colorful ceiling art.",
    lat: 51.92,
    lon: 4.4866,
  ...
  },
  {
    name: "Livraria Lello",
    description:
      "Ornate bookstore considered one of the world’s most beautiful.",
    lat: 41.1471,
    lon: -8.6148,
  ...
  // Toronto, Canada
  {
    name: "CN Tower",
    description:
      "Iconic tower with observation decks and a revolving restaurant.",
    lat: 43.6426,
    lon: -79.3871,
  ...
  },
  {
    ...
    description:
      "Museum with extensive collections of art, culture, and natural history.",
    lat: 43.6677,
    lon: -79.3948,
  ...
  },
  {
    ...
    description:
      "Historic pedestrian area with galleries, shops, and restaurants.",
    lat: 43.6503,
    lon: -79.3593,
  ...
  // Montreal, Canada
  {
    name: "Old Montreal",
    description:
      "Historic district with cobblestone streets and colonial architecture.",
    lat: 45.5078,
    lon: -73.5545,
  ...
  },
  {
    name: "Mount Royal",
    description:
      "Urban park with trails and city views designed by Frederick Law Olmsted.",
    lat: 45.5017,
    lon: -73.5873,
  ...
  },
  {
    name: "Marine Drive",
    description:
      "Scenic promenade along the Arabian Sea, known as the Queen’s Necklace.",
    lat: 18.944,
    lon: 72.8237,
  ...
  },
  {
    name: "Old Medina",
    description:
      "Historic walled city with markets and traditional architecture.",
    lat: 33.6001,
    lon: -7.6198,
  ...
  // Wellington, New Zealand
  {
    name: "Te Papa Museum",
    description:
      "National museum with Māori culture and natural history exhibits.",
    lat: -41.2904,
    lon: 174.7821,
  ...
  },
  {
    name: "Milford Sound",
    description:
      "Fjord with dramatic cliffs and marine life, accessible by tour.",
    lat: -44.6713,
    lon: 167.9252,
  ...
  },
  {
    name: "Huayna Picchu",
    description:
      "Mountain peak with steep trails offering views of Machu Picchu.",
    lat: -13.1575,
    lon: -72.5468,
    address: "Machu Picchu, 08680, Peru",
  ...
  // Moscow, Russia
  {
    name: "Red Square",
    description:
      "Historic square with Saint Basil’s Cathedral and the Kremlin.",
    lat: 55.7539,
    lon: 37.6208,
  ...
  // Saint Petersburg, Russia
  {
    ...
    description:
      "One of the world’s largest art museums, in the Winter Palace.",
    lat: 59.9398,
    lon: 30.3146,
  ...
  // Cebu City, Philippines
  {
    ...
    description:
      "Historic church with the oldest Catholic icon in the Philippines.",
    lat: 10.2942,
    lon: 123.9021,
  ...
  // Bergen, Norway
  {
    name: "Bryggen",
    description:
      "UNESCO-listed Hanseatic wharf with colorful wooden buildings.",
    lat: 60.3971,
    lon: 5.3242,
