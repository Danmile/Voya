  ...
  return (
    <div className="h-screen w-screen flex flex-col lg:flex-row">
      <div className="flex flex-col items-center justify-center mt-40 gap-10 z-1 px-6 lg:gap-15 lg:w-1/2 lg:mt-20">
        <h1 className="font-bold text-4xl text-gray-700">Register</h1>
        <p className="text-center text-xl text-gray-600 -mt-5">Just a couple</p>
        <p className="text-center text-xl text-gray-600 -mt-12 lg:-mt-15">
          of details to begin
        </p>
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-md">
          <div className="flex flex-col gap-8">
            ...
            <Link
              className="text-sm text-gray-700 font-medium underline flex justify-center md:text-lg"
              to="/login"
            >
              Flashbacks of current account?
            </Link>
          </div>
        </form>
      </div>
