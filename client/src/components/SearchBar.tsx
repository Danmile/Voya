    ...
    <div className="bg-white rounded-4xl w-full mx-auto font-semibold drop-shadow-xl">
      ...
      >
        <div className="flex md:flex-row gap-4 flex-1 p-1">
          ...
          <div className="hidden md:flex justify-center items-center bg-green-100 rounded-4xl p-4">
        ...
        <button className="bg-blue-500 rounded-4xl p-1 flex items-center justify-center gap-1 cursor-pointer md:p-3">
          <h1 className="hidden md:block rounded-4xl text-white font-normal mx-2">
            Find my adventure
          </h1>
          <div className="md:bg-white rounded-4xl p-2.5 text-white md:text-black">
            <Search />
          </div>
        </button>
      </form>
